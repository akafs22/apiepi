...
public class UsuarioController : ControllerBase
{
    ...
    {
        var colaboradorCad = _context.Colaboradors.FirstOrDefault(e => e.Email == model.Email && e.Cpf == model.Cpf);
    ...
    {
        var colaboradorCad = _context.Colaboradors.FirstOrDefault(e => e.Email == Email && e.Cpf == Cpf);
        var userExiste = _context.Users.FirstOrDefault(u => u.Email == Email && u.Cpf == Cpf);
